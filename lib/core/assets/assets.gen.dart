...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/plumbing.png
  AssetGenImage get plumbing =>
      const AssetGenImage('assets/icons/plumbing.png');
...
class $AssetsIconsNavGen {
  ...
  /// File path: assets/icons/nav/add.svg
  SvgGenImage get add => const SvgGenImage('assets/icons/nav/add.svg');

  /// File path: assets/icons/nav/browser.svg
  SvgGenImage get browser => const SvgGenImage('assets/icons/nav/browser.svg');
  ...
  /// File path: assets/icons/nav/task.svg
  SvgGenImage get task => const SvgGenImage('assets/icons/nav/task.svg');

  /// List of all assets
  List<SvgGenImage> get values => [add, browser, home, settings, task];
}
